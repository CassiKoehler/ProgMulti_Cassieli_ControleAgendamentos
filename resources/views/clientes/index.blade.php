...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-white-900 mb-2">Gestão de Clientes</h1>
            <p class="text-gray-600">Cadastre e gerencie seus clientes de forma eficiente</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 mb-8">
            <div class="flex items-center mb-6">
                ...
                <div>
                    <h2 class="text-xl font-semibold text-gray-900">Novo Cliente</h2>
                    <p class="text-gray-600 text-sm">Preencha os dados do cliente</p>
                </div>
            </div>
            ...
            @if (session('error'))
                <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 5000)" x-show="show" x-transition
                    class="bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded-lg mb-6 flex items-start justify-between">
                    <div class="flex items-start">
                        <svg class="w-5 h-5 mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
                <div class="flex items-center mb-4 sm:mb-0">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">Gerencie e visualize todos os clientes</p>
                    </div>
                </div>
            </div>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            {{ \Carbon\Carbon::parse($cliente->data_cadastro)->format('d/m/Y H:i') }}
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="3" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-500">Comece cadastrando seu primeiro cliente usando o formulário
                                                acima.</p>
                                        </div>
                                    </td>
                                </tr>
