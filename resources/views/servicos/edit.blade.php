...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-white-900 mb-2">Editar Serviço</h1>
            <p class="text-gray-600">Modifique as informações do serviço</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 mb-8">
            <div class="flex items-center mb-6">
                ...
                <div>
                    <h2 class="text-xl font-semibold text-gray-900">Editar Serviço</h2>
                    <p class="text-gray-600 text-sm">Atualize os dados do serviço</p>
                </div>
            </div>
            ...
            <form action="{{ route('servicos.update', $servico->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="descricao" id="descricao" rows="3"
                        ...
                        placeholder="Detalhes sobre o serviço">{{ old('descricao', $servico->descricao) }}</textarea>
                    @error('descricao')
                        <p class="text-red-500 text-sm mt-1 flex items-center">
                            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center pt-4 border-t border-gray-200 space-y-3 sm:space-y-0">
                    ...
                    <div class="flex space-x-3">
                        <a href="{{ route('servicos.index') }}" 
                            class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold px-6 py-3 rounded-lg transition-colors duration-200 inline-flex items-center">
                        ...
                        <button type="submit" 
                            class="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-lg transition-colors duration-200 flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-blue-700 text-sm">Certifique-se de que todas as informações estão corretas antes de salvar as alterações.</p>
                </div>
            </div>
        </div>
    </div>
