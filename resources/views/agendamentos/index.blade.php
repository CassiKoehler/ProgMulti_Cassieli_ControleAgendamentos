    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-6">
        ...
        @if(session('success'))
            <div class="max-w-7xl mx-auto mb-6">
                <div
                    class="bg-green-50 border border-green-200 text-green-800 px-6 py-4 rounded-xl shadow-sm flex items-center">
                ...
                <div class="p-8">
                    <form action="{{ route('agendamentos.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-2">
                                <label for="profissional_id" class="block text-sm font-semibold text-slate-700">Profissional
                                    *</label>
                            ...
                            <div class="space-y-2">
                                <label for="data_hora" class="block text-sm font-semibold text-slate-700">Data e Hora
                                    *</label>
                            ...
                            <div class="space-y-2 md:col-span-2 lg:col-span-1">
                                <label for="observacao"
                                    class="block text-sm font-semibold text-slate-700">Observação</label>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-slate-200">Gerencie e visualize todos os agendamentos</p>
                            </div>
                        </div>
